...
plt.yticks(size=80)
plt.text(fdates[3],-0.25, "Total Precipitation Deviation Change = " + tChange + " +/- " + terror + " (mm/hr)", fontsize = 80)
...
plt.savefig("Precipitation_Time_Series_Anomalies.png") # Save plot as a png.