...
while i < 262:  #(change to your number of files)
    ...
    if(month + 1) == 13:
     ...
     outdata = open("rainy_LST_outdata.txt","a")
    ...
    #elif(((month + 1) == 9 and year == 2001) or ((month + 1) == 10 and year == 2001)):
    #  month = month + 1
    #  date = str(year) + str(month)
    #  outdata = open("rainy_LST_outdata.txt","a")
    #  outdata.write(date + " " + str(0.0) + " " + str(0.0) + "\n")
